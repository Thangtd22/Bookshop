    ...
    <head>
        ...
        <script>
            ...
            function doDelete(id)
            {
                ...
                if (c)
                {
                    window.location.href = "deletebooks?bookID=" + id;
                }
            }
        </script>
    </head>
                    ...
                    <tbody>
                        <c:forEach items="${books}" var="b">
                            <tr>
                                ...
                                <td>${b.price} $</td>
                                <td>
                                    <a href="editbooks?bookID=${b.bookID}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#" class="delete" data-toggle="modal" onclick="doDelete(${b.bookID})"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                            ...
                            <div class="form-group">
                                ...
                                <select name="genre" class="form-select" aria-label="Default select example">
                                    <c:forEach items="${listgenre}" var="lg">
                                        <option value="${lg.genreID}">${lg.genreType}</option>
                                    </c:forEach>
                                </select>
                            </div>
