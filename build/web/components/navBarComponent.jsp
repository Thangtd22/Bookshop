<%-- 
    ...
    Created on : Mar 7, 2024, 3:31:17 PM
    Author     : DELL
--%>
...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="home"><img src="assets/book.ico"/>BOOK SHOP</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <c:if test="${sessionScope.acc.isSell == 1}">    
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="managebooks">Manage Books</a>
                    </li>
                </c:if>
            ...
            <form action="search" class="d-flex mx-auto" >
                <div class="group">
                    <input placeholder="Search" value="${key}" type="search" class="form-control" name="keyword" aria-label="Search">
                </div>
                <button style="margin-left: 5px" class="btn btn-primary" type="submit">
