                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <form action="updatecartquantity">
                                    <tr>
                                    <input type="hidden" name="bookID" value="${C.value.book.bookID}"/>
                                        <th scope="row">${C.value.book.bookID}</th>
                                        <td>${C.value.book.name}</td>
                                        <td><img src="${C.value.book.imageURL}" width="50"/></td>
                                        ...
                                        <td><a href="deletecart?bookID=${C.value.book.bookID}" class="btn btn-outline-danger"><i class="bi bi-trash"></i>Delete</a></td>
                                    </tr>
                                </form>
                            </c:forEach>
                            </tbody>
